...
public class DynexPool : PoolBase
{
    ...
    private async Task OnLoginAsync(StratumConnection connection, Timestamped<JsonRpcRequest> tsRequest)
    {
        ...
        double hashrateLimit = networkHashrate * 0.4;

        //Do not allow new miners if hashrate of the pool is over 40% of network hashrate
    ...
    {
//            case CryptonightHashType.CryptonightDynexSolve:
                return $"dynexsolve";
    }

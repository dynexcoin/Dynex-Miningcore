...
public class SendTransactionRequest
{
    ...
    /// </summary>
    [JsonProperty("fee")]
    public ulong Fee { get; set; } = 1000000;
    ...
    /// <summary>
    /// (Optional) Valid and existing address in the dynex wallet container used by walletd (Dynex Wallet RPC), it will receive the change of the transaction
    /// IMPORTANT RULES:
